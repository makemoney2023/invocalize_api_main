...
app.post('/business/Singlefamily', async (req, res, next) => {
	let { content, currentPrompt, area, province, country, city, streetAddress, postalCode, price, bed, bath, style, lotDimensions, yearBuilt, ameneties} = req.body
  
	let prompt = ""
	let inputRaw = ""

	if(currentPrompt === "Basic Ad"){
		prompt = `Acting as an experienced real estate listing writer who captivates the attention of your readers, Create a detailed real estate listing description from the text:\n###\n` +
